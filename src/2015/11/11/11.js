//(function(THREE){
    ...
    function initialize() {
        ...
        camera.projectionMatrix = THREE.Matrix4.makeOrthographic( window.innerWidth / - 2, window.innerWidth / 2, window.innerHeight / 2, window.innerHeight / - 2, - 2000, 10000 );
        ...
        meshCanvas = new THREE.Mesh( plane, new THREE.MeshBasicMaterial( { map: grass, wireframe: true } ));
